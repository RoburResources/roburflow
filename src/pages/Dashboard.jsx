  ...
  return (
    <div className="p-4 md:p-8 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
        <Stat icon={ListChecks} label="Assigned" value={counts.assigned} accent="bg-slate-100 text-slate-600" />
        <Stat icon={Clock} label="In Progress" value={counts.in_progress} accent="bg-blue-100 text-blue-600" />
        <Stat icon={FileCheck} label="Awaiting Review" value={counts.submitted} accent="bg-robur-goldLight text-robur-goldDark" />
        <Stat icon={Send} label="Sent to Client" value={counts.sent} accent="bg-green-100 text-green-600" />
      </div>
